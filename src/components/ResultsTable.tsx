  ...
  return (
    <div className="overflow-x-auto -mx-2 sm:mx-0">
      <table className="w-full min-w-[720px] sm:min-w-0 table-fixed">
        <thead>
            <tr className="border-b-2 border-slate-200/80 bg-gradient-to-r from-slate-50 via-blue-200/40 to-indigo-300/30">
        ...
        <tbody className="divide-y divide-slate-100">
          {results.map((result, index) => {
            ...
            return (
              <tr key={`${result.platform}-${index}`} className="hover:bg-gradient-to-r hover:from-slate-50/80 hover:to-blue-200/40 transition-all duration-200 border-b border-slate-100/80 group">
