          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <div className="flex items-center gap-2">
              <div className="relative">
                <input
                  ...
                  className="w-32 px-3 py-2.5 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white transition-all font-medium text-slate-900 hover:border-slate-400 hover:bg-slate-50/50 shadow-sm"
                  placeholder="0,00"
                />
              ...
              className={`px-2.5 py-1.5 text-xs rounded-lg border transition-all duration-200 shadow-sm ${lengthOption === '45' ? 'bg-gradient-to-r from-slate-500 to-slate-600 text-white border-slate-500 shadow-slate-500/30 hover:shadow-slate-500/40 hover:scale-105' : 'bg-white text-slate-700 border-slate-300 hover:border-slate-400 hover:bg-slate-50'}`}
            >
              45 cm Zincir
            </button>
            <button
              ...
              className={`px-2.5 py-1.5 text-xs rounded-lg border transition-all duration-200 shadow-sm ${lengthOption === '60' ? 'bg-gradient-to-r from-slate-500 to-slate-600 text-white border-slate-500 shadow-slate-500/30 hover:shadow-slate-500/40 hover:scale-105' : 'bg-white text-slate-700 border-slate-300 hover:border-slate-400 hover:bg-slate-50'}`}
            >
              60 cm Zincir
            </button>
            <button
              ...
              className={`px-2.5 py-1.5 text-xs rounded-lg border transition-all duration-200 shadow-sm ${silverChain45Enabled ? 'bg-gradient-to-r from-slate-500 to-slate-600 text-white border-slate-500 shadow-slate-500/30 hover:shadow-slate-500/40 hover:scale-105' : 'bg-white text-slate-700 border-slate-300 hover:border-slate-400 hover:bg-slate-50'}`}
            ...
            <div className="flex items-center gap-2 bg-gradient-to-r from-slate-50/80 to-blue-50/30 px-2.5 py-1.5 rounded-lg border border-slate-200 shadow-sm">
              ...
              <input
                ...
                className={`w-20 px-2 py-1 text-xs border border-slate-300/70 rounded-md focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white shadow-sm disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed ${expenses.specialPackaging === 0 ? 'pointer-events-none opacity-60' : ''}`}
                placeholder="150"
              />
            ...
            <div className="flex items-center gap-2 bg-gradient-to-r from-slate-50/80 to-blue-50/30 px-2.5 py-1.5 rounded-lg border border-slate-200 shadow-sm">
              ...
              <input
                ...
                className={`w-20 px-2 py-1 text-xs border border-slate-300/70 rounded-md focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white shadow-sm disabled:bg-slate-100 disabled:text-slate-400 disabled:cursor-not-allowed ${expenses.premiumBox === 0 ? 'pointer-events-none opacity-60' : ''}`}
                placeholder="300"
              />
              <span className="text-[11px] text-gray-500">TL</span>
              <label className="relative inline-flex items-center cursor-pointer">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full px-2.5 py-2 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white shadow-sm hover:bg-slate-50/50 transition-colors"
                    placeholder="0,00"
                  />
            ...
            <div className="grid grid-cols-4 gap-2 items-end">
              <div>
                ...
                <input
                  ...
                  onChange={(e) => updateExpenses('shipping', parseFloat(e.target.value) || 0)}
                    className="h-9 w-full px-2 pr-8 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white text-center shadow-sm hover:bg-slate-50/50 transition-colors"
                />
              ...
              <div>
                ...
                <input
                  ...
                  className="h-9 w-full px-2 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white text-center shadow-sm hover:bg-slate-50/50 transition-colors"
                  placeholder="1.00"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="relative">
                <input
                  ...
                  className="w-full px-2 py-1.5 pr-8 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white font-medium text-slate-900 text-center shadow-sm hover:bg-slate-50/50 transition-colors disabled:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-500"
                  placeholder="Senaryo adı"
                />
                <button
                  onClick={() => removePlatform(index)}
                  className="absolute top-1/2 right-1.5 -translate-y-1/2 w-5 h-5 flex items-center justify-center text-slate-400 hover:text-white hover:bg-gradient-to-r hover:from-slate-600 hover:to-slate-700 rounded-full transition-all duration-200 shadow-sm hover:shadow-md group z-10"
                  title="Senaryoyu sil"
                >
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-2 py-1.5 text-sm border border-slate-300/70 rounded-lg focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white text-center font-semibold shadow-sm hover:bg-slate-50/50 transition-colors"
                      placeholder="0"
                    />
                  </div>
                  <div>
                ...
                <label className="block text-xs text-slate-600 mb-1 font-medium">
                  ...
                  <div className="relative">
                    <input
                      ...
                      disabled={platform.name === 'Standart'}
                      className="w-full pr-8 px-2 py-1.5 text-sm border-2 border-slate-300 rounded-lg focus:ring-2 focus:ring-slate-500/50 focus:border-slate-500 bg-white text-center font-semibold hover:bg-slate-50/50 transition-colors disabled:bg-slate-100 disabled:cursor-not-allowed disabled:text-slate-500"
                      placeholder="0"
                    />
                    <span className="absolute right-2 top-1/2 -translate-y-1/2 text-xs text-slate-500 font-medium">TL</span>
                  </div>
